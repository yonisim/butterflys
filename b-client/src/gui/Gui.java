...
import algorithms.ImageSerializable;
import algorithms.ImageTransformer;
...
public class Gui extends javax.swing.JFrame {
    ...
    private void btnSearchActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSearchActionPerformed
      ...
      //  	Butterfly ans = _manager.getClosestImage(bi.getRGBMean(filteredImage));
			...
			ImageSerializable IS = _manager.search(image);
			
			ImageIcon ans = new ImageIcon(ImageTransformer.ISToBufferedImage(IS));
			
            SearchResView showAns = new SearchResView();
            //showAns.setButterflyAns(filteredImage);
            showAns.setButterflyAns(ans , IS.butterflyName , IS.butterflyDescription);
    ...
    private void btnAddDetailsActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAddDetailsActionPerformed
        ...
        try{
            ...
            {
            	BufferedImage image = ImageIO.read(new File(_ImgPath));
            	// ImageIcon imageIcon = new ImageIcon(image);
                if(_manager.AddToDB(image, _Name,_Description))
                	JOptionPane.showMessageDialog(null, "Butterfly added to Data Base", "Add butterfly", JOptionPane.INFORMATION_MESSAGE);
                else
                	JOptionPane.showMessageDialog(null, "ERROR ocured while inserting butterfly to DB", "Add butterfly", JOptionPane.ERROR_MESSAGE);
                resetGui();
